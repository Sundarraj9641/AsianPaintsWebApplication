...
import com.pagefactory.PaintBudgetCalculatorPagefactory;
...
public class PaintBudgetCalculator {

	WebDriver driver = SetUpDriver.chromeDriver();
	PaintBudgetCalculatorPagefactory pbcp;
	...
	public void user_hover_the_mouse_on_Paints_and_Colours() throws InterruptedException {
		pbcp = new PaintBudgetCalculatorPagefactory(driver);
		pbcp=PageFactory.initElements(driver, PaintBudgetCalculatorPagefactory.class);
		pbcp.paints_Colours();
