...
import com.pagefactory.ColoursAndPaintsPageFactory;
import com.screenshot.ScreenshotCapture;
...
public class Colour_Catalogue {
	WebDriver driver = SetUpDriver.chromeDriver();
	ColoursAndPaintsPageFactory cpf;
	...
	public void user_hover_the_mouse_on_paints_and_colour() throws Exception {
		cpf = new ColoursAndPaintsPageFactory(driver);
		cpf=PageFactory.initElements(driver, ColoursAndPaintsPageFactory.class);
	    cpf.paintsColours();
