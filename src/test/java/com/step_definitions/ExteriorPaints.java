...
import com.pagefactory.ExteriorPaintsPageFactory;
...
public class ExteriorPaints {
	
	WebDriver driver= SetUpDriver.chromeDriver();
	ExteriorPaintsPageFactory eppf;
	...
	public void user_is_on_the_Exterior_paints_page() throws InterruptedException {
	    ...
	    eppf = new ExteriorPaintsPageFactory(driver);
	    eppf=PageFactory.initElements(driver, ExteriorPaintsPageFactory.class);
